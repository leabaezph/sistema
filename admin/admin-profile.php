			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Perfil del Administrador</h2>
	<?php	
$aid=$_SESSION['id'];
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading">Perfil del Administrador</div>
										...
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													El nombre de usuario no se puede cambiar.</span> </div>
											</div>
											<div class="form-group">
...
<div class="form-group">
									<label class="col-sm-2 control-label">Fecha/Hora de Registro</label>
									<div class="col-sm-10">
...
<div class="form-group">
				...
				<input type="password" class="form-control" value="" required="required" id="cpassword" name="cpassword" >
												...
												<div class="col-sm-6 col-sm-offset-4">
													<button class="btn btn-default" type="submit">Cancelar</button>
													<input type="submit" name="changepwd" Value="Actualizar Contraseña" class="btn btn-primary">
											</div>
