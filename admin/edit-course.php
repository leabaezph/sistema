...
$coursefn=$_POST['cnf'];
$id=$_GET['id'];
$query="update nationalities set nacionality_code=?,course_sn=?,course_fn=? where id=?";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
												<?php	
												$id=$_GET['id'];
	$ret="select * from nationalities where id=?";
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
					...
					<div class="col-sm-8">
					<input type="text"  name="cc" value="<?php echo $row->nacionality_code;?>"  class="form-control"> </div>
					</div>
				 <div class="form-group">
