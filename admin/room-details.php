...
<button type="button" onclick="tenemosDatosBusqueda(<?php echo $row->id; ?>)" class="btn btn-primary">Tenemos datos de la persona</button>
<button type="button" onclick="EcontramosALaPersona(<?php echo $row->id; ?>)" class="btn btn-primary">Encontramos a la persona</button>
<?php
} ?>
                            </div>
                        </div>
 ...
 */
    ...
    function cancelarBusqueda(id) {
        ...
        let reason = prompt("ingrese el motivo de su cancelación", "ya lo encontramos");
        let   text;
    ...
    function tenemosDatosBusqueda(id) {
            $.ajax({
                type:'POST',
                url:'tenemosDatosBusqueda.php',
                data:{'id':id},
                success:function(response){
                    console.log(response);
                    console.log("se cargo bien");
    ...
    function EcontramosALaPersona(id) {
            $.ajax({
                type:'POST',
                url:'EcontramosALaPersona.php',
                data:{'id':id},
                success:function(response){
                    console.log(response);
                    console.log("se cargo bien");
