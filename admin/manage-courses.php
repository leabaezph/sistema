...
{
	$id=intval($_GET['del']);
	$adn="delete from nationalities where id=?";
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">All nationalities Details</div>
...
<td><?php echo $row->nacionality_code;?></td>
